...
<form action="../controle/cadastrar_usuario.php" method="post">
    Nome: <input type="text" name="txt_user" required><br>
    E-mail: <input type="email" name="txt_mail" required><br>
    Senha: <input type="password" name="txt_pass" required><br>
    Confirmar Senha: <input type="password" name="txt_conf" required><br>
